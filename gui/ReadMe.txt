========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Wrip
========================================================================


Diese Wrip-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Wrip.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Wrip.rc eingebunden.
...
WripDlg.h, WripDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CWripDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in Wrip.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	Wrip.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
